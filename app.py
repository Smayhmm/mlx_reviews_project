...
# def submit():
#     num_profiles = request.form.get('num_profiles')
#     profile_type = request.form.get('profile_type')
#     warm_up = request.form.get('warm_up')
#     review_link = request.form.get('review_link')

#     # Check if all required fields are present
#     if not all([num_profiles, profile_type, warm_up, review_link]):
#         return "All required fields must be filled out", 400

#     try:
#         # Convert num_profiles to an integer
#         num_profiles = int(num_profiles)
#         execute_script(num_profiles, profile_type, warm_up, review_link)
#     except ValueError:
#         return "Number of profiles must be a numeric value", 400
...
def post_review(driver, message):
    """Post a review on Google Maps."""
    driver.get("https://www.google.com/")
    time.sleep(3)
    driver.get("https://www.google.com/maps/place/Campground+B+-+Alamo+Lake+State+Park/@34.2426258,-113.5862695,7340m/data=!3m1!1e3!4m6!3m5!1s0x80d3b3d089f48311:0x53172787fd3e0114!8m2!3d34.2319489!4d-113.5805634!16s%2Fg%2F11hx38x9j0?entry=ttu")
    time.sleep(8)
...
if __name__ == "__main__":
    ...
    PROFILEID = "09400797-4834-4eeb-a3dd-bf9123bf4412"
    ...
    try:
        ...
        profile_update()
        time.sleep(20)
        subprocess.run(['python3', "C:/Users/MatheusDias/Desktop/Automation Projects/Google Reviews Project/cookie_robot.py"])
